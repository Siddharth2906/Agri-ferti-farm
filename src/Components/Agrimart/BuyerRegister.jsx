...
const determineErrorField = (errorMessage) => {
    ...
    if (errorMessage_lower.includes('phoneNumber')) return 'phoneNumber';
...
const BuyerRegister = () => {
    ...
    const isFormValid = () => {
        const newErrors = {
            fullName: validateField("fullName", user.name),
            ...
            password: validateField("city", user.city),
            password: validateField("state", user.state),
        ...
        try {
            ...
            try {
                ...
                if (response.data.success) {
                    ...
                    // Reset form
                    setUser({name: "", email: "", phoneNumber: "", password: "", profilePictureUrl: "",city:"",state:"" });
                    setErrors({name: "", email: "", phoneNumber: "", password: "",city:"",state:""  });
