...
import DEFAULT_PFP from '../../images/images.png'
...
const determineErrorField = (errorMessage) => {
    ...
    if (errorMessage_lower.includes('phone')) return 'village';
    if (errorMessage_lower.includes('password')) return 'password';
    return null;
};
...
const FarmerRegister = () => {
    ...
    const isFormValid = () => {
        const newErrors = {
            ...
            village: validateField("village", user.village),
            password: validateField("password", user.password),
            city: validateField("city", user.city),
            state: validateField("state", user.state),
            pincode: validateField("pincode", user.pincode),
            farmtype: validateField("farmtype", user.farmtype),
            farmsize:validateField("farmsize",user.farmsize)
        };
        ...
        try {
            ...
            try {
                ...
                if(response.data.success) {
                    ...
                    // Reset form
                    setUser({ name: "", password: "", email: "", village: "", password: "", profilePictureUrl: "", city:"", state:"", farmsize:"", farmtype:"",pincode:"" });
                    setErrors({  password: "", email: "", village: "", password: "", city:"", state:"", farmsize:"", farmtype:"",pincode:"" });
