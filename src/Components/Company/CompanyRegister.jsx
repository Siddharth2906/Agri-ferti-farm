...
const determineErrorField = (errorMessage) => {
    ...
    if (errorMessage_lower.includes('name')) return 'name';
    if (errorMessage_lower.includes('contactEmail')) return 'contactEmail';
    if (errorMessage_lower.includes('contactPhone')) return 'contactPhone';
    if (errorMessage_lower.includes('password')) return 'password';
    if (errorMessage_lower.includes('type')) return 'type';
    if (errorMessage_lower.includes('city')) return 'city';
    if (errorMessage_lower.includes('state')) return 'state';
    return null;
};
...
const CompanyRegister = () => {
    ...
    const isFormValid = () => {
        const newErrors = {
            ...
            contactEmail: validateField("contactEmail", user.contactEmail),
            contactPhone: validateField("contactPhone", user.contactPhone),
